...
urlpatterns = [
    ...
    path("watch_list/api/all/<int:user_id>/", views.watch_list_api_all, name="watch_list_api_all"),
    path("watch_list/add/api/<int:user_id>/", views.add_watch_list_api, name="add_watch_list_api"),
    path("watch_list/remove/api/<int:user_id>/", views.remove_watch_list_api, name="remove_watch_list_api"),
